...
// support. Based on the public-domain civil calendar algorithm by H. Hinnant.
...
bool clockIsTrusted() {
  // 2024-01-01T00:00:00Z. A freshly booted ESP32 starts near the Unix epoch.
  return nowEpochMilliseconds() >= 1704067200000LL;
}

bool parseUtcIso8601(const String& value, int64_t& epochMilliseconds) {
  // The Agent emits Date.toISOString(): YYYY-MM-DDTHH:mm:ss.sssZ.
